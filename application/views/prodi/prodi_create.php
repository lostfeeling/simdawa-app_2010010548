        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">Tambah Data Jenis Prodi </h2>
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="nama_prodi" required placeholder="Nama Jenis Prodi" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
